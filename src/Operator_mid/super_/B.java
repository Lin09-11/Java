...
public class B extends A {
    ...
    public void test() {
        ...
        System.out.println("super.n1=" + super.n1);//找A类，如果A类没有，则找A类的父类
//        super.cal();
    }
    ...
    public void sum() {
        ...
        // 提示：如果查找方法的过程中，找到了，但是不能访问（在父类中是私有的）， 则报错, cannot access
        ...
        //(2) 如果没有，则找父类(如果有，并可以调用，则调用)
        //(3) 如果父类没有，则继续找父类的父类,整个规则，就是一样的,直到 Object类
        // 提示：如果查找属性的过程中，找到了，但是不能访问（在父类中是私有的）， 则报错, cannot access
